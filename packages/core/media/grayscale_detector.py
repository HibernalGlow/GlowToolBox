...
class GrayscaleConfig:
    ...
    white_score_threshold: float = 0.95  # 调整为更合理的阈值
...
class GrayscaleResult:
    ...
    def removal_reason(self) -> Optional[str]:
        ...
        try:
            ...
            logging.error(f"removal_reason计算错误: {str(e)}")
            return None
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir', type=str, default='D:/1VSCODE/1ehv/pics/test', help='要测试的图片目录')
