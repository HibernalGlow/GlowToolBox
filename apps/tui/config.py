...
class ConfigTemplate(App[None]):
    ...
    #buttons-container Button {
        width: 100%;
        margin-bottom: 0;  /* 减少按钮之间的间距 */
        margin: 0 0 0 1;  /* 只保留左边距 */
        background: $primary;
        color: $text;
        border: none;
    }
    ...
    .params-container {
        ...
        grid-gutter: 0;  /* 减少网格间距 */
        background: transparent;
        padding: 0;
        height: auto;
        margin-top: 0;  /* 减少顶部margin */
    }
